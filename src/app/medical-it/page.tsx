...
export default function MedicalITPage() {
  return (
    <>
      ...
      >
        <HeroBackground type="grid" color="124, 58, 237" />
        ...
        <div className="relative z-10 min-h-[80dvh] sm:min-h-dvh flex items-center">
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-0">
            <div className="backdrop-blur-md bg-black/40 border border-white/10 p-8 sm:p-10 lg:p-14 max-w-xl">
              ...
              <Link
                href="#audit"
                className="inline-flex items-center gap-4 bg-[#7C3AED] text-white py-3 sm:py-4 px-6 sm:px-8 uppercase tracking-widest text-xs font-light hover:gap-6 transition-all w-fit focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED] focus-visible:ring-offset-2 focus-visible:ring-offset-black/40"
              >
            ...
            {deliverables.map((item) => {
              ...
              return (
                <article key={item.title}>
                  <div className="bg-[#7C3AED]/10 p-4 sm:p-6 lg:p-8 h-full border-l-2 border-[#7C3AED]/30 hover:bg-[#7C3AED]/15 hover:border-[#7C3AED]/50 transition-colors">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-[#7C3AED]/20 flex items-center justify-center mb-3 sm:mb-4 lg:mb-6">
                      <Icon
                        className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#7C3AED]/70"
                        strokeWidth={1.5}
                        aria-hidden="true"
                      />
                    </div>
                  ...
                  >
                    ...
                    <td className="py-4">
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-[#7C3AED] text-[10px] sm:text-xs uppercase tracking-widest hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED]"
              ...
              return (
                <article key={step.number}>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4 -mt-6 sm:-mt-8 lg:-mt-10 relative z-10">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#7C3AED]/10 flex items-center justify-center flex-shrink-0">
                      <Icon
                        className="w-4 h-4 text-[#7C3AED]/70"
                        strokeWidth={1.5}
                        aria-hidden="true"
                      />
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-16">
            ...
            <div className="lg:col-span-5">
              <div className="bg-[#7C3AED]/10 aspect-square flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
                <Shield
                  className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 text-[#7C3AED]/40 mb-3 sm:mb-4 lg:mb-6"
                  strokeWidth={1}
                  aria-hidden="true"
                />
                <span className="text-[40px] sm:text-[52px] lg:text-[70px] xl:text-[84px] font-heading text-[#7C3AED] leading-none text-center">
                  Zero
                </span>
                <div
                  className="w-10 h-px sm:w-12 bg-[#7C3AED]/30 my-3 sm:my-4 lg:my-6"
                  aria-hidden="true"
                />
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                <div className="flex items-start gap-3 sm:gap-4 lg:gap-6">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-[#7C3AED]/10 flex items-center justify-center flex-shrink-0">
                    <Search
                      className="w-4 h-4 sm:w-5 sm:h-5 text-[#7C3AED]/70"
                      strokeWidth={1.5}
                      aria-hidden="true"
                    />
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            {faqItems.map((item, idx) => (
              <details
                key={idx}
                className="group bg-kronos-card border border-white/5 hover:border-[#7C3AED]/20 transition-colors"
              >
                <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none">
                  <h3 className="font-body text-xs sm:text-sm text-white font-normal pr-4">
                    {item.question}
                  </h3>
                  <span className="text-[#7C3AED] flex-shrink-0" aria-hidden="true">+</span>
                </summary>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <article>
              <div className="bg-kronos-card border-l-2 border-[#7C3AED]/30 hover:border-[#7C3AED]/60 hover:bg-kronos-gray-800 transition-colors p-6 sm:p-8 lg:p-10 h-full flex flex-col">
                <p className="text-[10px] sm:text-xs uppercase tracking-widest text-[#7C3AED]/60 mb-3">
                  Revenue Cycle
                </p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 text-[#7C3AED] text-xs uppercase tracking-widest hover:gap-5 transition-all w-fit focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED]"
                >
      ...
      <section className="py-8 sm:py-10 bg-kronos-bg border-t border-white/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/revenue-cycle"
              className="text-[#7C3AED] hover:underline text-sm font-light"
            >
